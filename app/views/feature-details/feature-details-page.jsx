...
const Eyebrow = ({ children, className = "" }) => (
  <div
    className={`inline-flex items-center gap-2.5 font-mono text-[11px] font-medium uppercase tracking-[0.24em] text-[#d9384a] ${className}`}
  >
    <span className="h-px w-6 bg-[#d9384a]/50" aria-hidden="true" />
    {children}
  </div>
);
...
const SectionHeading = ({ eyebrow, title, description }) => (
  <div className="mx-auto max-w-2xl text-center">
    ...
    <h2 className="mt-5 font-serif text-[28px] font-normal leading-[1.15] tracking-[-0.01em] text-[#14181c] sm:text-[36px] md:text-[40px]">
      {title}
    </h2>
    {description && (
      <p className="mx-auto mt-5 max-w-xl font-sans text-[15.5px] leading-[1.7] text-[#5b6472] sm:text-base">
        {description}
      </p>
    )}
  </div>
...
const FeatureDetailsPage = ({ data }) => {
  ...
  return (
    <main className="bg-[#fbfaf8]">
      ...
      {/* ============================================================ */}
      <section className="relative overflow-hidden bg-[#fbfaf8] pt-28 sm:pt-36">
        <div
          aria-hidden="true"
        ...
        <div className="relative mx-auto max-w-3xl px-5 text-center sm:px-8">
          ...
          <h1 className="mt-6 font-serif text-[36px] font-normal leading-[1.1] tracking-[-0.01em] text-[#14181c] sm:text-[52px] md:text-[60px]">
            {hero.title}{" "}
            <span className="italic text-[#d9384a]">
        ...
        <div className="relative mx-auto mt-24 max-w-5xl px-5 pb-28 sm:mt-32 sm:px-8 sm:pb-36">
          <ScreenshotStage>
            <WindowFrame
              src={hero.image}
              alt={hero.title}
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-5xl px-5 py-28 sm:px-8 sm:py-36 lg:px-12">
          <SectionHeading
      ...
      {/* ============================================================ */}
      <section className="relative overflow-hidden bg-[#14181c] py-28 sm:py-36">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-1/2 h-[420px] w-[640px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(closest-side,rgba(217,56,74,0.2),transparent)] blur-3xl"
        />

        <div className="relative mx-auto max-w-2xl px-5 text-center sm:px-8">
          <Eyebrow className="justify-center">Book a Demo</Eyebrow>
          <h2 className="mx-auto mt-6 max-w-lg font-serif text-[32px] leading-[1.15] text-white sm:text-[42px] md:text-[48px]">
            {cta.title}
          </h2>
          <p className="mx-auto mt-5 max-w-lg font-sans text-[15.5px] leading-relaxed text-white/70">
            {cta.description}
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <button
              type="button"
              className="group inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#d9384a] px-7 py-3.5 font-sans text-sm font-semibold text-white transition-all hover:bg-[#b92b3c] hover:shadow-xl hover:shadow-[#d9384a]/20 sm:w-auto"
            >
              {cta.primaryCta}
              <ArrowUpRight
                size={15}
            ...
            <button
              type="button"
              className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/20 px-7 py-3.5 font-sans text-sm font-medium text-white transition-all hover:border-white/40 hover:bg-white/10 sm:w-auto"
            >
              {cta.secondaryCta}
            </button>
          </div>
